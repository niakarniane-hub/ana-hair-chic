...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        luxury:   "0 12px 40px hsl(152 40% 12% / 0.14)",
        "luxury-xl": "0 24px 64px hsl(152 40% 12% / 0.18)",
        gold:     "0 4px 20px hsl(42 65% 52% / 0.25)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
